...
import { type PlainTile } from './Tile.types'

const TileContent = ({ points, value }: { points: number, value: number }): JSX.Element => {
...
function Tile ({ value, points, onTileClick, selected, disabled }: PlainTile): JSX.Element {
  ...
  return (
        <Button
            ...
            cursor={disabled ? 'default' : (onTileClick != null) ? 'pointer' : 'default'}
            overflow="hidden"
            position="relative"
