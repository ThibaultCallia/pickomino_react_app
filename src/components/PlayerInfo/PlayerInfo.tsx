import { Button, Drawer, DrawerBody, DrawerContent, DrawerFooter, DrawerHeader, DrawerOverlay, SimpleGrid, useDisclosure, useMediaQuery } from "@chakra-ui/react";
        ...
        <>
          ...
          <Drawer isOpen={isOpen} placement="right" onClose={onClose}>
            ...
            <DrawerContent>
              ...
              <DrawerBody>
                <SimpleGrid spacing={1} columns={1} alignItems="flex-start">
